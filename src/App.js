...
useEffect(() => {
  ...
  return (
    ...
    <div className="App">
      <React.Fragment>
        <BarNav setSesionIniciada={setSesionIniciada} sesionIniciada={sesionIniciada} functionVisibilityBarnav2={functionVisibilityBarnav2} visibilityLogIn={visibilityLogIn} setVisibilityLogIn={setVisibilityLogIn} setVisibilityChat={setVisibilityChat} setVisibilityHelp={setVisibilityHelp} visibilityHelp={visibilityHelp} />
    ...
    <Routes>
      <Route element={<Hogar visibilityLogIn={visibilityLogIn} />} path='/'></Route>
      ...
      <Route element={<UneteAhora nuevoUsuario={nuevoUsuario} setNuevoUsuario={setNuevoUsuario}/>} path='/registro'></Route>
      ...
      <Route element={<AlquilarPersonasFree serviciosDisponibles={serviciosDisponibles} />} path='/freealquilerpersona'></Route>
      <Route element={<Buscar personasDePrueba={personasDePrueba} />} path='/search'></Route>
      <Route element={<CrearServicio usuarioPresente={usuarioPresente}  serviciosDisponibles={serviciosDisponibles} setServiciosDisponibles={setServiciosDisponibles} />} path='/crearServicio'></Route>
      <Route element={<Perfil setUsuarioPresente={setUsuarioPresente} usuarioPresente={usuarioPresente} />} path='/perfil'></Route>
      <Route element={<CrearSolicitud solicitudesDisponibles={solicitudesDisponibles} setSolicitudesDisponibles={setSolicitudesDisponibles} /> } path='/crearSolicitud' ></Route> 
