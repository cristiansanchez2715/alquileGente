...
function BarNav({setSesionIniciada, sesionIniciada, functionVisibilityBarnav2, visibilityLogIn, setVisibilityLogIn, setVisibilityChat, setVisibilityHelp, visibilityHelp}) {
  ...
  return (
    ...
    <img className='img-homero' src={homeroImg} />
      </div> }
