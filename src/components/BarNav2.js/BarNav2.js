...
import IMG4 from '../../assets/not-found/chatPublicoPlusIMG-removebg-preview.png'
...
<div className='container-title-select'>
  <h2 style={{color: "white"}}>Seleccione el objeto a crear</h2>
</div>
...
<div className='btn-barnav2-container' onClick={() => functionVisibilityChat()}>
<button className='btn-img-barnav2' ><img src={IMG4} className='img-barnav-2' /></button>
<h2 className='title-barnav2'>Chat</h2>
</div>
