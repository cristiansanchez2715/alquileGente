...
const [img, setImg] = useState('/static/media/');
//const [stateImg, setStateImg] = useState(`${imgP}${imagenUsuario}`)
...
const handleSubmitImage = () => {
  ...
  fetch('http://localhost:4000/enviarImagen', {
    method: 'POST',
    body: formData
  })
...
backgroundRepeat: "no-repeat",
  ...
  height: '200px',
    ...
    return (
      ...
      <img className='img-perfil' src={imgPrueba} alt='Imagen de perfil' /> 
    {visibilityPerfilPhoto && <img src={urlImagePerfil} alt='No cargo F'/>} 
 {visibilityPerfilPhoto &&  <div style={backgroundImageStyle}></div> } 
            <div className='subir-fotodeperfil' style={{marginTop: "50px" ,display: "flex", flexDirection: "column"}}>
